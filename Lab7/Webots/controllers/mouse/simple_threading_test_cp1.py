...
class MainWindow(QMainWindow):
    def __init__(self,params_obj,sim):
        ...
        b=QPushButton('Run')
        b.pressed.connect(self.sim.run)
...
if __name__ == '__main__':
    ...
    sim=Simulation(reflex_params)
    app = QApplication([])
    win=MainWindow(reflex_params,sim)
